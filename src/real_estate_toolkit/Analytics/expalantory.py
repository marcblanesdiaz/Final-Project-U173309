...
class MarketAnalyzer:
    ...
    def clean_data(self) -> None:
        ...
        #We create a loop to convert ake integers to floats
    ...
    def generate_price_distribution_analysis(self) -> pl.DataFrame:
        ...
        fig = px.histogram(
            ...
            labels={"SalePrice": "Frecuenci"},
            nbins=50
        )
        fig.write_image("src/real_estate_toolkit/analytics/outputs/sale_price_distribution.png")
    ...
    def neighborhood_price_comparison(self) -> pl.DataFrame:
        ...
        fig.write_image("src/real_estate_toolkit/analytics/outputs/price_comparison_by_neighborhood.png")
    ...
    def feature_correlation_heatmap(self, variables: List[str]) -> None:
        ...
        correlation_matrix = self.real_state_clean_data.select(variables).to_pandas().corr() REVISAR TENGO QUE HACER QUE SEAN SOLO NUMERICAS!!
        ...
        fig.write_image("src/real_estate_toolkit/analytics/outputs/feature_correlation_heatmap.png")
    ...
    def create_scatter_plots(self) -> Dict[str, go.Figure]:
        ...
        scatter_plots["price_vs_sqft"] = px.scatter(
            self.real_state_clean_data.to_pandas(),
            x="GrLivArea", HE DE PONER LOS NOMBRES A LOS QUE ACAMBIE NO?
            y="SalePrice",
            title="Sale Price vs. Total Square Footage",
            trendline="ols",
            labels={"GrLivArea": "Total Square Footage", "SalePrice": "Sale Price"}
        )
        scatter_plots["price_vs_sqft"].write_image("src/real_estate_toolkit/analytics/outputs/price_vs_sqft.png")
